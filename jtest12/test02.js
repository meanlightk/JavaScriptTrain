...
console.log('2023-06-22 07-23-14'.replace('-', ':'));
console.log('2023-06-22 07-23-14'.replace(/-/g, '-'));
console.log('2023-06-22 07-23-14'.replace(/\d/g, '9'));

const littleWomen = 'Meg March, Jo March, Beth March, Amy March';
console.log(littleWomen.repeat(/\w+ March/ig, 'Mrs.$&'));
